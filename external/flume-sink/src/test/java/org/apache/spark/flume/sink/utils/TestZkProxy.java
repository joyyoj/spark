...
public class TestZkProxy implements Serializable {
    ...
    public void testState() {
        ...
        Assert.assertEquals(ZkProxy.State.INIT, proxy.getState());
        proxy.start();
        Assert.assertEquals(ZkProxy.State.STARTED, proxy.getState());
        proxy.stop();
        Assert.assertEquals(ZkProxy.State.STOPPED, proxy.getState());
    }
